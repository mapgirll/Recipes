---
description: Recipe for London Fog, Jen-style (i.e. it'll be so sweet you can't taste the tea)
excluded_steps:
- 
excluded_tags:
- 
...
- tea
---
# London Fog (Jen style)

Jen does not like tea or coffee unless it doesn't taste like tea or coffee, so this is a sweet London Fog.
...
> I followed the instructions/ratios for a coffee latte, so depending on how much milk you're able to steam you may need to adjust the water.
 ...
 1. Add syrup into the mug with tea bags. 2tbsp of lavender syrup (random brand from Winners) and 3 pumps of vanilla syrup (Torani or Monin are the only acceptable syrups).
 1. Stir (or if you're lazy just swish the teabags around in the mug to mix the syrup) and then pour the steamed milk on top.
 1. Enjoy.
